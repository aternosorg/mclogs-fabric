...
public class MclogsFabric implements DedicatedServerModInitializer, ClientModInitializer, ModInitializer {
    ...
    public static int share(Source source, String filename) {
        ...
        if (!log.toFile().exists() || !isInAllowedDirectory
            ...
            source.sendError(Text.literal("There is no log or crash report with the name '" + filename
        ...
        try {
            ...
            MutableText error = Text.literal("The log file " + filename + " doesn't exist. Use '/mclogs list' to list all logs.");
    ...
    public void onInitializeClient() {
        ...
        ClientCommandRegistrationCallback.EVENT.register(((dispatcher, registryAccess) -> {
            ...
            for (Command command : COMMANDS) {
                dispatcher.register(command.buildClient(mclogsc));
            }
        }));
    }
